...
// Build a 7×24 day-of-week × hour-of-day count matrix in local time
// (uses the runner's TZ — fine for a personal site, less fine for a SaaS).
// Day 0 = Sunday so the heatmap reads Sun-Sat top to bottom.
function bucketByDayHour(scrobbles) {
